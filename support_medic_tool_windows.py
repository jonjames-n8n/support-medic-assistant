#!/usr/bin/env python3
"""
Cloud Medic Assistant Tool v1.4 - Windows Edition
Interactive CLI for n8n Cloud Support operations

Windows Edition Notes:
- Fully cross-platform (Windows, macOS, Linux)
- Uses subprocess with list arguments (secure, no shell injection)
...
class CloudMedicTool:
    ...
    def setup_workspace(self):
        ...
        self.print_header("Cloud Medic Assistant - Setup v1.4 (Windows Edition)")
...
"""
    ...
    def show_pre_menu(self):
        ...
        print(f"\n{Colors.BOLD}{Colors.CYAN}{'═' * 60}{Colors.END}")
        print(f"{Colors.BOLD}{Colors.CYAN}{'SUPPORT MEDIC ASSISTANT v1.4 (Windows)':^60}{Colors.END}")
        print(f"{Colors.BOLD}{Colors.CYAN}{'═' * 60}{Colors.END}\n")
